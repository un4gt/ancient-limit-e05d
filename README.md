...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/ancient-limit-e05d#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-limit-e05d
```

A live public deployment of this template is available at [https://ancient-limit-e05d.templates.workers.dev](https://ancient-limit-e05d.templates.workers.dev)
